	...
	if(candidates.len)
		...
		for (var/obj/effect/landmark/L in world)
			if(L.name == "voxstart")
				...
				new_vox << "\blue You are a Vox Primalis, fresh out of the Shoal. Your ship has arrived at a human-meat system hosting the NSV Dawn... or was it the Luna? NSS? Utopia? Nobody is really sure, who cares about stupid meat-names anyway? Everyone is raring to start pillaging! Your current goal is: \red<B> [input]</B>"
